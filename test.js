...
var resultRecettes = [];
for (var i = 1; i <= recettes.length; i++) {
	var o = {};
  o.id = i;
...
function arrayMethodSearch(recettes, stringSearch, resultRecettes) {
 ...
 arrayMethodSearch(recettes, "ail", resultRecettes);
 arrayMethodSearch(recettes, "inconnu", resultRecettes);

function legacySearch(recettes, stringSearch, resultRecettes) {
 ...
 legacySearch(recettes, "ail", resultRecettes);
 legacySearch(recettes, "inconnu", resultRecettes);

 // url JSBen.ch = https://jsben.ch/6j1NO